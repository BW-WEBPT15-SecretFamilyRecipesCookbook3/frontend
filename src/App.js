    ...
    <div className="App">
      <header className="App-header">
        ...
        <label><h1> Register</h1></label>
          <label>
           Full Name:
            <input type="text" placeholder="First Name" onChange={event => setSignIn(event.target.value)} />
            .<input type="text" placeholder="Last Name" onChange={event => setSignIn(event.target.value)} />
           <br></br>
            Email Address (Username) :
            <input type="text" placeholder="Email Address" onChange={event => setSignIn(event.target.value)} />
           <br></br>
            Password:
            ...
            <input type="text" placeholder="Confirm Password" onChange={event => setSignIn(event.target.value)} />
